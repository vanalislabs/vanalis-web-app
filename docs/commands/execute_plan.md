...
- Mulai dengan header yang menyertakan nomor plan dan timestamp awal eksekusi
...
- Akhiri dengan timestamp selesai eksekusi dan ringkasan keseluruhan
...
[AGENT_1] - 2024-01-15 10:00:00 - LOCK: Mengedit src/components/Button.tsx
[AGENT_1] - 2024-01-15 10:00:00 - Checklist item 3: Create Button component
[AGENT_1] - 2024-01-15 10:05:00 - File: src/components/Button.tsx - Created new component
[AGENT_1] - 2024-01-15 10:05:00 - UNLOCK: Selesai mengedit src/components/Button.tsx
[AGENT_1] - 2024-01-15 10:05:00 - Status: Checklist item 3 selesai
```
...
Pastikan dokumen EXECUTION_XXXXXX.md berfungsi sebagai log lengkap dari proses eksekusi dengan timestamp untuk setiap langkah penting.
...
2. **Lock Mechanism untuk File:**
   ...
   - Format: `[AGENT_ID] - [TIMESTAMP] - LOCK: Mengedit file <path/to/file>`
   - Setelah selesai, catat: `[AGENT_ID] - [TIMESTAMP] - UNLOCK: Selesai mengedit file <path/to/file>`
...
4. **Koordinasi Update EXECUTION_XXXXXX.md:**
   ...
   - Gunakan format yang konsisten dengan agent identifier: `[AGENT_ID] - [TIMESTAMP] - ...`
...
[AGENT_1] - 2024-01-15 10:00:00 - LOCK: Mengedit src/components/Button.tsx
[AGENT_1] - 2024-01-15 10:05:00 - UNLOCK: Selesai mengedit src/components/Button.tsx
[AGENT_1] - 2024-01-15 10:05:00 - Checklist item 3 selesai: Create Button component

Agent 2 mencatat di EXECUTION:
[AGENT_2] - 2024-01-15 10:00:00 - LOCK: Mengedit src/api/users.ts
[AGENT_2] - 2024-01-15 10:07:00 - UNLOCK: Selesai mengedit src/api/users.ts
[AGENT_2] - 2024-01-15 10:07:00 - Checklist item 7 selesai: Create users API endpoint
```
