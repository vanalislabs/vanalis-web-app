      ...
      <div className="max-w-6xl mx-auto w-full">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Track your data contributions and earnings
          </p>
        </div>
            ...
            <div className="space-y-4">
              {submissions.length === 0 && (
                <div className="flex items-center justify-center py-16">
                  <p className="text-black">Submission is empty</p>
                </div>
              )}
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge
                              className={
                                submissionStatus[submission.status].className
                              }
                            >
                      ...
                      <div className="flex gap-2">
                        <Link to={`/projects/${submission.projectId}`}>
                          <Button
                            variant="outline"
                            size="sm"
                            data-testid={`button-view-project-${submission.id}`}
                          >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge
                              className={submissionStatus.APPROVED.className}
                            >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge
                              className={submissionStatus.PENDING.className}
                            >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge
                              className={submissionStatus.REJECTED.className}
                            >
